//Breakdown:
//1. First find a method a to get the sqroot a given number => Math.sqrt(givenNumber)
//2. How to find if a given number is a perfect square.
// 2.1 In order to do that, find if the sqroot a number is not a perfect square.
...
// add one to the given number and multiply that number to itself, in order to return the perfect square of a number.
