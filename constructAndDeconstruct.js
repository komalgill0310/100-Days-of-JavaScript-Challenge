// Breakdown:
// 1. split the given string and store it in a variable called strSplit
// 2. Create an empty array called constructArr
// 3. Create an empty array called deconstructArr
// 4. Create an empty string and store it in a variable called constructStr
// FOR CONSTRUCT
// 5. use for loop to loop over the given string
// ===> 1. constructStr += str[i]
// ===> 2. push constructStr into constructArr
// FOR DECONSTRUCT
// 6. use for loop to loop over the given string => Start the loop from 1 till the i is < str.length
...
// 7. Create a variable called constructAndDeconstructArr and join constructArr and deconstructArr
